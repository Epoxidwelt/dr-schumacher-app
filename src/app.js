...
const PRODUCTS = [
  {id:'aseptoman-med',sku:'00-457OP-0005-01',name:'ASEPTOMAN® MED',category:'hands',kind:'Händedesinfektionsmittel',spectrum:['begrenzt viruzid PLUS'],summary:'Alkoholisches Händedesinfektionsmittel für die hygienische und chirurgische Händedesinfektion.',facts:['Wirksam innerhalb von 30 Sekunden gegen Noro-, Adeno- und Rotaviren','Hervorragende Hautverträglichkeit durch pflegende Rückfetter','Frei von quartären Ammoniumverbindungen'],sizes:['50 ml','100 ml','150 ml','500 ml','700 ml (ESH Vacu-Bag kurze Pumpe)','700 ml (ESH Vacu-Bag lange Pumpe)','1 L','5 L'],color:'#0876d1'},
  {id:'aseptoman-gel',sku:'00-409-0015-02',name:'ASEPTOMAN® GEL',category:'hands',kind:'Händedesinfektionsgel',spectrum:['begrenzt viruzid'],summary:'Gelförmiges Präparat für eine einfache, kontrollierte Händedesinfektion.',facts:['Angenehme Gelkonsistenz','Für die häufige Anwendung geeignet','Sehr gute Verteilung auf den Händen'],sizes:['150 ml','500 ml','1 L'],color:'#0876d1'},
  {id:'aseptoman-viral',sku:'00-410OP-0015',name:'ASEPTOMAN® VIRAL',category:'hands',kind:'Händedesinfektionsmittel',spectrum:['viruzid'],summary:'Händedesinfektionsmittel mit erweitertem Wirkungsspektrum für besondere Anforderungen.',facts:['Breites Wirkungsspektrum','Für hygienische und chirurgische Händedesinfektion','Aktuelle Einwirkzeiten bitte der Produktinformation entnehmen'],sizes:['150 ml','500 ml','1 L'],color:'#0876d1'},
  {id:'descoderm',sku:'00-401-0015-02',name:'DESCODERM',category:'hands',kind:'Händedesinfektionsmittel',spectrum:['begrenzt viruzid'],summary:'Farbstoff- und parfümfreies Händedesinfektionsmittel für sensible Haut.',facts:['Frei von Farb- und Parfümstoffen','Für sensible Haut geeignet','Für medizinische Bereiche'],sizes:['150 ml','500 ml','1 L','5 L'],color:'#0876d1'},
  {id:'descosept-sensitive',sku:'00-323DS-005',name:'DESCOSEPT SENSITIVE',category:'surface',kind:'Gebrauchsfertige Flächendesinfektion',spectrum:['begrenzt viruzid PLUS'],summary:'Alkoholische Schnelldesinfektion für materialempfindliche, patientennahe Flächen.',facts:['Schnell trocknend','Gute Materialverträglichkeit','Gebrauchsfertig und einfach anzuwenden'],sizes:['500 ml','750 ml','1 L','2,5 L','5 L','10 L'],color:'#44ad45'},
  {id:'descosept-sensitive-wipes',sku:'00-323DS-T060',name:'DESCOSEPT SENSITIVE WIPES',category:'surface',kind:'Reinigungs- und Desinfektionstücher',spectrum:['begrenzt viruzid PLUS'],summary:'Gebrauchsfertige Tücher für die schnelle Reinigung und Desinfektion mittelgroßer Flächen.',facts:['Schnelle Einzelentnahme','Nachhaltige Bio-Vlies-Variante verfügbar','Ideal für patientennahe Bereiche'],sizes:['60 Tücher','100 Tücher'],color:'#44ad45'},
  {id:'descosept-spezial',sku:'00-208-005',name:'DESCOSEPT SPEZIAL',category:'surface',kind:'Alkoholfreie Flächendesinfektion',spectrum:['begrenzt viruzid'],summary:'Alkoholfreie gebrauchsfertige Reinigung und Desinfektion für empfindliche Oberflächen.',facts:['Ohne Alkohole, Aldehyde und Phenole','Für empfindliche Oberflächen','Reinigend und desinfizierend'],sizes:['500 ml','750 ml','1 L','5 L'],color:'#44ad45'},
  {id:'ultrasol-oxy',sku:'00-270-T072',name:'ULTRASOL OXY® WIPES',category:'surface',kind:'Reinigungs- und Desinfektionstücher',spectrum:['viruzid','sporizid'],summary:'Oxidative Reinigung und Desinfektion mit sehr breitem Wirkungsspektrum.',facts:['Viruzid und sporizid','Für Routine und Ausbruchsfall','Dualauslobung als Biozid- und Medizinprodukt'],sizes:['72 Tücher'],color:'#44ad45'},
  {id:'ultrasol-active',sku:'00-255-0004',name:'ULTRASOL® ACTIVE',category:'surface',kind:'Desinfektionsmittel-Konzentrat',spectrum:['viruzid','sporizid'],summary:'Pulverkonzentrat für anspruchsvolle Reinigung und Flächendesinfektion.',facts:['Breites Wirkungsspektrum','Praktisch staubfreie Anwendung','Gute Reinigungsleistung'],sizes:['40 g','1 kg'],color:'#44ad45'},
  {id:'perfektan-active',sku:'00-155-0004',name:'PERFEKTAN® ACTIVE',category:'instruments',kind:'Manuelle Instrumentenaufbereitung',spectrum:['viruzid'],summary:'Konzentrat zur manuellen Reinigung und Desinfektion medizinischer Instrumente.',facts:['Für das Tauchbadverfahren','Breites Wirkungsspektrum','Materialschonende Formulierung'],sizes:['40 g','1 kg'],color:'#7956b3'},
  {id:'descoton-extra',sku:'00-150-010',name:'DESCOTON EXTRA',category:'instruments',kind:'Instrumentendesinfektion',spectrum:['begrenzt viruzid PLUS'],summary:'Reinigendes und desinfizierendes Präparat für die manuelle Instrumentenaufbereitung.',facts:['Reinigung und Desinfektion in einem Schritt','Für medizinische Instrumente','Dosierung gemäß Produktinformation'],sizes:['1 L','2 L','5 L'],color:'#7956b3'},
  ...
  {id:'wipes-spender',sku:'00-915-SKD001',name:'VLIESTUCHSPENDER 3 L, KLEIN',category:'application',kind:'Spender und Applikation',spectrum:[],summary:'Wiederverwendbares Spendersystem für getränkte Vliestücher.',facts:['Einfache Anwendung','Verschiedene Größen verfügbar','Aufbereitungshinweise beachten'],sizes:['1 Stück','6 Stück'],color:'#ef829a'}
];
...
function productCard(product) {
  ...
  return `<article class="product-row" data-product="${product.id}">
    ...
    <div class="row-price">${state.customerMode?'<strong class="hidden-price">Preis verborgen</strong><small>Kundenmodus</small>':`<strong>${money(price)}</strong><small>${perUnit || state.priceList}</small>`}</div>
...
function pricePerUnit(product, size) {
  ...
  if (!units || price === '' || price == null || isNaN(Number(price))) return null;
  return Number(price) / units;
}
...
async function importExcel(event) {
  ...
  try {
    ...
    const workbook = isCsv ? XLSX.read(await file.text(), {type:'string'}) : XLSX.read(await file.arrayBuffer());
